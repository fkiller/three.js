	...
	constructor( renderer, gl ) {
		...
		this.setSession = async function ( value ) {
			...
			if ( session !== null ) {
				...
				const canUseProjectionLayer = supportsGlBinding && renderer.capabilities.isWebGL2 === true && XRWebGLBinding.prototype && typeof XRWebGLBinding.prototype.createProjectionLayer === 'function';
